"use strict";
(self["webpackChunkkuber"] = self["webpackChunkkuber"] || []).push([["default-src_app_erp-budget_modules_dashboard_dashboard_module_ts"],{
...
/***/ 42229:
/*!**************************************************************************!*\
  !*** ./src/app/erp-budget/modules/dashboard/dashboard-routing.module.ts ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _pages_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pages/dashboard/dashboard.component */ 39533);
...
const routes = [
    ...
    { path: '', component: _pages_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_0__.DashboardComponent, canActivate: [src_app_erp_procurement_data_services_AccessControlAuthGuard_service__WEBPACK_IMPORTED_MODULE_1__.RoutePrivilegeGuard], data: { clientName: 'BudgetModule', requiredPrivilege: ['Dashboard'] } },
];
...
/***/ 95374:
/*!******************************************************************!*\
  !*** ./src/app/erp-budget/modules/dashboard/dashboard.module.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dashboard-routing.module */ 42229);
/* harmony import */ var _pages_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/dashboard/dashboard.component */ 39533);
...
/* harmony import */ var _pages_gen_widgets_gen_widgets_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/gen-widgets/gen-widgets.component */ 10630);
...
/* harmony import */ var _pages_components_reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/components/reset-password/reset-password.component */ 97171);
/* harmony import */ var _pages_components_analytics_analytics_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/components/analytics/analytics.component */ 95195);
...
/***/ 95195:
/*!************************************************************************************************!*\
  !*** ./src/app/erp-budget/modules/dashboard/pages/components/analytics/analytics.component.ts ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 97171:
/*!**********************************************************************************************************!*\
  !*** ./src/app/erp-budget/modules/dashboard/pages/components/reset-password/reset-password.component.ts ***!
  \**********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 39533:
/*!*************************************************************************************!*\
  !*** ./src/app/erp-budget/modules/dashboard/pages/dashboard/dashboard.component.ts ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/reset-password/reset-password.component */ 97171);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/core */ 3184);
...
/* harmony import */ var _gen_widgets_gen_widgets_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../gen-widgets/gen-widgets.component */ 10630);
/* harmony import */ var _components_analytics_analytics_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/analytics/analytics.component */ 95195);
...
/***/ 10630:
/*!*****************************************************************************************!*\
  !*** ./src/app/erp-budget/modules/dashboard/pages/gen-widgets/gen-widgets.component.ts ***!
  \*****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class GenWidgetsComponent {
    constructor(router, SupplierCategoryService, budgetManService, tokenCookieService) {
        this.router = router;
        this.SupplierCategoryService = SupplierCategoryService;
        this.budgetManService = budgetManService;
        this.tokenCookieService = tokenCookieService;
        this.pendingBudgetsCount = 0;
        this.approvedBudgetsCount = 0;
        this.rejectedBudgetsCount = 0;
        this.returnedBudgetsCount = 0;
    }
    ngOnInit() {
        this.currentUserCode = this.tokenCookieService.getUser().empPfNo;
        this.fetchBudgets("PENDING");
        this.fetchBudgets("APPROVED");
        this.fetchBudgets("REJECTED");
        this.fetchBudgets("RETURNED");
    }
    fetchBudgets(status) {
        let params = { employeeCode: this.currentUserCode, status: status };
        this.budgetManService.getBudgetsByStatus(params).subscribe({
            next: (res) => {
                if (res.entity && res.entity.length > 0) {
                    if (status == "PENDING") {
                        this.pendingBudgetsCount = res.entity.length;
                    }
                    if (status == "APPROVED") {
                        this.approvedBudgetsCount = res.entity.length;
                    }
                    if (status == "REJECTED") {
                        this.rejectedBudgetsCount = res.entity.length;
                    }
                    if (status == "RETURNED") {
                        this.returnedBudgetsCount = res.entity.length;
                    }
                }
            },
            error: (err) => { },
            ...
            rxjs__WEBPACK_IMPORTED_MODULE_3__.Subscription;
    }
    // navigateToBudgets(status: string) {
    //   this.router.navigateByUrl(`erp-Budget/Budget-management/all-Budget`);
    // }
    navigateToBudgets(status) {
        let route = "erp-Budget/Budget-management/all-Budget";
...
GenWidgetsComponent.ɵfac = function GenWidgetsComponent_Factory(t) { return new (t || GenWidgetsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](src_app_erp_suppliersmanagement_data_supplier_categories_service__WEBPACK_IMPORTED_MODULE_0__.SupplierCategoriesService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](src_app_erp_budget_data_services_budget_service__WEBPACK_IMPORTED_MODULE_1__.BudgetsService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](src_app_core_service_token_storage_cookies_service__WEBPACK_IMPORTED_MODULE_2__.TokenCookieService)); };
GenWidgetsComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: GenWidgetsComponent, selectors: [["app-gen-widgets"]], decls: 45, vars: 4, consts: [[1, "row"], [1, "col-lg-3", "col-sm-6", 3, "click"], [1, "info-box7", "bg-kingdom", "order-info-box7"], [1, "info-box7-block"], [1, "m-b-20"], [1, "text-end"], [1, "float-start"], [1, "fas", "fa-clock"], [1, "m-b-0"], [1, "fas", "fa-check"], [1, "fas", "fa-reply"], [1, "fas", "fa-times"]], template: function GenWidgetsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "div", 0)(1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function GenWidgetsComponent_Template_div_click_1_listener() { return ctx.navigateToBudgets("PENDING"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](2, "div", 2)(3, "div", 3)(4, "h4", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](5, " Pending ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function GenWidgetsComponent_Template_div_click_12_listener() { return ctx.navigateToBudgets("APPROVED"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](13, "div", 2)(14, "div", 3)(15, "h4", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](16, "Approved ");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function GenWidgetsComponent_Template_div_click_23_listener() { return ctx.navigateToBudgets("RETURNED"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](24, "div", 2)(25, "div", 3)(26, "h4", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](27, "Returned ");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function GenWidgetsComponent_Template_div_click_34_listener() { return ctx.navigateToBudgets("REJECTED"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](35, "div", 2)(36, "div", 3)(37, "h4", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](38, "Rejected ");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate"](ctx.pendingBudgetsCount);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](11);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate"](ctx.approvedBudgetsCount);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](11);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate"](ctx.returnedBudgetsCount);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](11);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate"](ctx.rejectedBudgetsCount);
    } }, styles: [".bg-kingdom[_ngcontent-%COMP%] {\n  background: linear-gradient(to right, #002a23, #004D40, #5B7A47);\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
//# sourceMappingURL=default-src_app_erp-budget_modules_dashboard_dashboard_module_ts.js.map