...
//   private readonly INACTIVITY_TIMEOUT = 720000; // 3 minutes in milliseconds
//   //private readonly INACTIVITY_TIMEOUT = 60000; // 3 minutes in milliseconds

//   private readonly COUNTDOWN_TIMEOUT = 300000; // 30 seconds in milliseconds
...
//       ) {
//         this.signOut(this.tokenStorage.getUser().refreshToken).subscribe();
//       }
//     });
//   }
// }
