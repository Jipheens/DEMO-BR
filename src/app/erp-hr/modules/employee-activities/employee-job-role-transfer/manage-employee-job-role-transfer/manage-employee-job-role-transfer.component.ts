...
@Component({
    selector: 'app-manage-employee-job-role-transfer',
    templateUrl: './manage-employee-job-role-transfer.component.html',
    styleUrls: ['./manage-employee-job-role-transfer.component.sass']
})
export class ManageEmployeeJobRoleTransferComponent implements OnInit {
  ...
  patchEmployeeDetails(details: any) {
    this.mngForm.patchValue({
      ...
      jobGroupName: details.jobGroupName,
       });
  }
  branchLookup() {
    const dialogConfig = new MatDialogConfig();
