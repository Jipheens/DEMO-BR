...
export class RecursiveDeductionService {
headers = new HttpHeaders().set('Content-Type', 'application/json');
  baseURL = `${environment.baseUrlHR}/api/v1/payroll/custom/recursive-deduction`;
  ...
  validateBulkDedections(processedRows: any): Observable<any> {
