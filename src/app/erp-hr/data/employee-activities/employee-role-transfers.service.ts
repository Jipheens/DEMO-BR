...
export class EmployeeRoleTransferService {


  headers = new HttpHeaders().set('Content-Type', 'application/json');
  baseURL = `${environment.baseUrlHR}/api/v1/employee/role/transfer`;
  ...
  readByStatus(params: any): Observable<any> {
    ...
    getTransferByEmpName(params:any): Observable<any> {
    let API_URL = `${this.baseURL}/get/with/empname`;
    return this.http.get(API_URL, {params: params, headers: this.headers, withCredentials: false })
      .pipe(
        map((res) => {
          return res || {}
  ...
  ///all/by-emppf-and-status
  readByStatusAndEmpf(params: any): Observable<any> {
  ...
  verify(param: any,data: any): Observable<any> {
    console.log(param);
