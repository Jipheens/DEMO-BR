import {
  ...
  export class EmployeeDocumentsService {
    ...
    baseURL = `${environment.baseUrlHR}/api/v1/employee_documents`;
    
    constructor(private http: HttpClient) { }
  ///api/v1/employee_documents/create
    ...
    readByStatusAndEmpNationalId(params: any): Observable<any> {
      let API_URL = `${this.baseURL}/find_by_nationalid_status`;
    ...
    ///api/v1/employee_documents/find/by/id
