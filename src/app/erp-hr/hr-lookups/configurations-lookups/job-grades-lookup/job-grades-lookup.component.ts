...
import { ManageJobRolesComponent } from '../../../modules/configurations/job-roles/dialogs/manage-job-roles/manage-job-roles.component';
import { JobgroupService } from '../../../data/configuration-services/jobgroup.service';

@Component({
  selector: 'app-job-grades-lookup',
  templateUrl: './job-grades-lookup.component.html',
  styleUrls: ['./job-grades-lookup.component.sass']
})
export class JobGradesLookupComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ManageJobRolesComponent>,
  ...
  ngOnInit(): void {
    if (this.data.action === "SingleJobGrade") {
