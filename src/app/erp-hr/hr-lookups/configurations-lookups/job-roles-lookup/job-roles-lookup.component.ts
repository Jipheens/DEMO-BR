...
import { ManageJobGradesComponent } from '../../../modules/configurations/job-grades/dialogs/manage-job-grades/manage-job-grades.component';
import { JobRoleService } from 'src/app/erp-hr/data/configuration-services/jobrole.service';

@Component({
  selector: 'app-job-roles-lookup',
  templateUrl: './job-roles-lookup.component.html',
  styleUrls: ['./job-roles-lookup.component.sass']
})
export class JobRolesLookupComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ManageJobGradesComponent>,
