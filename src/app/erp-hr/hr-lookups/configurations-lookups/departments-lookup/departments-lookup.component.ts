...
import { ManageDepartmentsComponent } from '../../../modules/configurations/departments/dialogs/manage-departments/manage-departments.component';
import { DepartmentService } from '../../../data/configuration-services/department.service';

@Component({
  selector: 'app-departments-lookup',
  templateUrl: './departments-lookup.component.html',
  styleUrls: ['./departments-lookup.component.sass']
})
export class DepartmentsLookupComponent implements OnInit {
